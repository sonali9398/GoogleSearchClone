...
export const Navbar = ({dark, setDark}) => {
  return (
    ...
    justify-center border-b dark:border-gray-700 border-gray-200'>
        <div className='flex justify-between items-center space-x-5 w-screen'>
          ...
          <button type='button' onClick={() => setDark(!dark)} className="text-xl dark:bg-gray-50 dark:text-gray-900
